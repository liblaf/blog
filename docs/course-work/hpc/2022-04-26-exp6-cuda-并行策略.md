...
![naive](./2022-04-26-exp6-cuda-并行策略.assets/naive.png)

![shared_memory](./2022-04-26-exp6-cuda-并行策略.assets/shared_memory.png)

![compare-x](./2022-04-26-exp6-cuda-并行策略.assets/compare-x.png)

![compare-y](./2022-04-26-exp6-cuda-并行策略.assets/compare-y.png)
